...
convention for recording _decisions_ — the "why we chose X over Y" that
...
alternatives. Descriptive docs describe the _what-is_, not the _why-not-Y_.
...
- New contributors can read `docs/adr/README.md` and understand both _what was
  decided_ and _what is still open_ in one glance.
