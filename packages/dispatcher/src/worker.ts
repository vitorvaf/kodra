...
import { AGENT_CLI_ADAPTERS, type AgentRunProvider } from './adapters/registry.js';
...
const ADAPTERS: Partial<Record<AgentRunProvider, AgentCliAdapter>> = AGENT_CLI_ADAPTERS;
